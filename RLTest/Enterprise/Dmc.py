...
class Dmc():
    ...
    def __init__(self, dmcBinaryPath='~/.RLTest/opt/redislabs/bin/dmcproxy', libPath='~/.RLTest/opt/redislabs/lib/', directory=None):
        ...
        if 'LD_LIBRARY_PATH' in os.environ:
            ...
            self.env['LD_LIBRARY_PATH'] = os.path.expanduser(libPath) if dmcBinaryPath.startswith('~/') else libPath
