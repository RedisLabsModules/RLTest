...
class CcsMock():
    ...
    def __init__(self, redisBinaryPath=None, directory=None, useSlaves=False, password=None, proxyPort=10000):
    ...
    def setup(self, shards, bdb_fields=None, endpoint_ccs_params=None, legacy_hash_slots=True, extra_keys=None):
        ...
        self.process = subprocess.Popen(stdout=subprocess.PIPE, stderr=subprocess.STDOUT, args=self.args)
