...
class RLTest:
    ...
    def __init__(self):
        ...
        parser.add_argument(
            '--proxy-binary-path', default=None,
        ...
        Env.defaultProxyBinaryPath = self.args.proxy_binary_path if self.args.proxy_binary_path else '~/.RLTest/opt/redislabs/bin/dmcproxy'
    ...
    def execute(self):
        ...
        if self.args.env_only:
            env = Env(testName='manual_test_env', verbose=2)
        ...
        while self.tests:
            ...
            if self.currEnv.assertionFailed or exceptionRaised:
